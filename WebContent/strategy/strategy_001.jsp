	...
	<section id="blog" style="padding-top: 0px; padding-bottom: 0px; margin-bottom: 56px;">
		<div class="container" style="background: white; padding-bottom: 100px;">
			...
			<div class="row">
							...
							<article>
								<header class="entry-header">
									<div class="entry-thumbnail">
										<img class="img-responsive" src="http://static.sarah-house.cn/images/strategy_001_${ ind}.jpg" alt=""> <span class="post-format post-format-gallery"><i class="fa fa-image"></i></span>
									</div>
								</header>
							</article>
						</div>
				...
				<!--/.col-sm-6-->
				<div class="col-sm-6">
					<c:forEach begin="18" end="23" var="ind">
						<div class="blog-post blog-large wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms">
							<article>
								<header class="entry-header">
									<div class="entry-thumbnail">
