...
<body id="home" class="homepage">
	...
	<div id="home_text" class="text-center" style="margin-top: 150px;">
		...
		<br>
		<p class="wow fadeInDown" data-wow-duration="300ms" data-wow-delay="0ms">
			橘子最佳季节1月，三华李最佳季节3月，杨梅最佳季节5月，荔枝最佳季节6月底7月初，黄皮最佳季节7月中，<br>龙眼最佳季节7月底8月初，柿子最佳季节9月底，火龙果最佳季节全年
		</p>
	...
	<section id="blog" style="padding-top: 0px; padding-bottom: 0px; margin-bottom: 56px;">
		<div class="container" style="background: white; padding-bottom: 100px;">
			...
			<div class="row">
				<div class="col-sm-6">
					<c:forEach begin="10" end="16" var="ind">
						<div class="blog-post blog-large wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms">
							<article>
								<header class="entry-header">
									<div class="entry-thumbnail">
										<img class="img-responsive" src="http://static.sarah-house.cn/images/strategy_007_${ ind}.jpg" alt=""> <span class="post-format post-format-gallery"><i class="fa fa-image"></i></span>
									</div>
								</header>
							</article>
						</div>
				...
				<!--/.col-sm-6-->
				<div class="col-sm-6">
					<c:forEach begin="17" end="22" var="ind">
						<div class="blog-post blog-large wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms">
							<article>
								<header class="entry-header">
									<div class="entry-thumbnail">
