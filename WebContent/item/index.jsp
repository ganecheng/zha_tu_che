...
<body class="page-header-fixed">
	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<!-- /.modal -->
				<!-- BEGIN SAMPLE PORTLET CONFIGURATION MODAL FORM-->
				<div class="modal fade" id="see_info_detail_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					<div class="modal-dialog">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
							工地信息管理 <small>管理工程地区、项目类别、建筑面积、建设周期、项目简介等信息</small>
						</h3>
					...
					<div class="col-md-12 col-sm-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-user"></i> 工地信息管理
								</div>
								<div class="actions">
									<button id="add_listrecord_button" class="btn blue" data-toggle="modal" data-remote="true" href="item/ajax/add_listrecord.jsp" data-target="#add_listrecord_modal">
							...
							<div class="portlet-body">
								<div id="list_record_div" data-link="admin/show_list_record_list">
	...
	<script>
		$(function()
		{
			...
			$("#import_file_example_file_input_1").change(function()
			{
				if ($("#import_file_example_file_input_1").val().endWith(".xls"))
				{
					App.blockUI(
					{
						target : $("#table_box_div"),
						message : '<h2>正在添加中 , 请稍候 ...</h2>',
						iconOnly : false,
						overlayCSS :
						{
							backgroundColor : '#fff',
					...
					$('#import_file_example_1').submit();
				}
				else
				{
					alert("请选择后缀为.xls的excel文件");
				}
			});
			$("#import_file_example_file_input_2").change(function()
			{
				if ($("#import_file_example_file_input_2").val().endWith(".xls"))
				{
					App.blockUI(
					{
						target : $("#table_box_div"),
			...
			$("#import_file_example_file_input_3").change(function()
			{
				if ($("#import_file_example_file_input_3").val().endWith(".xls"))
				{
					App.blockUI(
					{
						target : $("#table_box_div"),
			...
			$('#import_file_example_1').ajaxForm(
			{
				success : processJson,
				dataType : 'json',
				clearForm : true
			});
			$('#import_file_example_2').ajaxForm(
			{
				success : processJson,
				dataType : 'json',
				clearForm : true
			});
			$('#import_file_example_3').ajaxForm(
			{
				success : processJson,
				dataType : 'json',
				clearForm : true
			...
			function processJson(data)
			{
				if (data.success == true)
				{
					...
					$("#list_record_div").load($("#list_record_div").attr("data-link"), {}, function()
					{
						setTimeout('App.unblockUI($("#table_box_div"))', 500);
					});
				}
				else
				{
					App.unblockUI($("#table_box_div"));
					alert(data.info);
				}
