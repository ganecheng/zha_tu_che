			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
							驾驶员信息管理 <small>管理驾驶员姓名、年龄、驾驶车辆、违章记录等信息</small>
						</h3>
					...
					<div class="col-md-12 col-sm-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-user"></i> 驾驶员信息管理
								</div>
								<div class="actions">
									<button id="add_listrecord_button" class="btn blue" data-toggle="modal" data-remote="true" href="item/ajax2/add_listrecord.jsp" data-target="#add_listrecord_modal">
										<i class="fa fa-plus"></i> 添加
									</button>
								</div>
							</div>
							<div class="portlet-body">
								<div id="list_record_div" data-link="admin/show_driver_list">
