				...
				<ul class="page-sidebar-menu" data-auto-scroll="true" data-slide-speed="200">
					...
					<li class="">
						...
						<ul class="sub-menu">
							...
							<li>
								<a target="_blank" href="item/index9.jsp">
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
							历史轨迹查询和回放 <small>渣土车历史行驶轨迹查询、路径回放</small>
						</h3>
					...
					<div class="col-md-12 col-sm-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-user"></i> 渣土车历史行驶轨迹查询、路径回放
								</div>
									...
									<table class="table table-striped table-bordered table-hover" id="sample_2">
										...
										<tbody>
											<tr class=" gradeX">
												...
												<td>淄博市运输公司</td>
												<td>张店区工地1</td>
												<td><a target="_blank" href="./index9.jsp">
														<span class="badge badge-success"> 轨迹回放 </span>
													</a></td>
											</tr>
											<tr class=" gradeX">
												<td><input type="checkbox" class="checkboxes" value="1"></td>
