			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
							违章报警管理 <small>渣土车未按规定路径行驶、货物装卸超出电子围栏区域、超速、超载等</small>
						</h3>
									...
									<table class="table table-striped table-bordered table-hover" id="sample_2">
										...
										<tbody>
											<tr class=" gradeX">
												...
												<td>2016.3.24</td>
												<td>未按规定路径行驶</td>
												<td><a target="_blank" href="./index8.jsp">
														<span class="badge badge-success"> 违章事件回放 </span>
													</a></td>
											</tr>
											<tr class=" gradeX">
												<td><input type="checkbox" class="checkboxes" value="1"></td>
