...
<body>
	...
	<div id="info_box_div">
		<div id="info_inner_box">
			<div class="input-group G-MarginTop5 G-MarginLeft5 G-MarginRight5">
				<input id="point_input" type="text" class="form-control" placeholder="请输入线的坐标">
				<span class="input-group-btn">
					<button id="change_line_button" class="btn btn-primary" type="button">修改这条线</button>
				</span>
			</div>
		</div>
	</div>
	<div class="button-group">
		<input type="button" class="button" value="开始编辑路径" onClick="editor.startEditLine()" />
		<input type="button" class="button" value="结束编辑路径" onClick="editor.closeEditLine()" />
	...
	<div id="template_of_line_edited">
		<div id="LICENSE_NUMBER" class="media section_div" data-x="DATA_X" data-y="DATA_Y" data-lines="DATA_LINES" style="display: none;">
			...
			<div class="media-body">
				<h4 class="media-heading">创建了一条新路线</h4>
	...
	<script type="text/javascript">
		...
		editor.closeEditLine = function()
		{
			...
			var temp_html = $("#template_of_line_edited").html();
			temp_html = temp_html.replace("WARNING_TIME", new Date().pattern("yyyy-MM-dd HH:mm:ss"));
			temp_html = temp_html.replace("WARNING_PLACE", "路线" + speed_flag);
		...
		$(function()
		{
			...
			$("#change_line_button").click(function()
			{
				...
				var lineArr = fromLineStrToLineArr(point_arr_str);
			...
			{
				var point_arr_str = $(this).attr("data-lines");
				var lineArr = fromLineStrToLineArr(point_arr_str);
				editor._line.setPath(lineArr);
			});
		});
