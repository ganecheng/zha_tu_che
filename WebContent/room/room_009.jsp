	...
	<section id="services" style="padding-top: 0px; padding-bottom: 0px;">
		<div class="container" style="background: white; padding-top: 50px; padding-bottom: 0px;">
			...
			<div class="section-header">
				<h2 class="section-title text-center wow fadeInDown">美庐度假别墅</h2>
					...
					<div class="row">
						<div class="col-sm-6">
							<ul class="nostyle">
								...
								<li>
									<i class="fa fa-check-square"></i> <strong>280m<sup>2</sup></strong> 面积
								</li>
								<li>
								...
								<li>
									<i class="fa fa-check-square"></i> <strong>1</strong> 间麻将房
								</li>
								<li>
						...
						<div class="col-sm-6">
							<ul class="nostyle">
								<li>
									<i class="fa fa-check-square"></i> <strong><span id="009_level_1"></span>元</strong> 周日至周四
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong><span id="009_level_2"></span>元</strong> 周五
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong><span id="009_level_3"></span>元</strong> 周六
								</li>
								<li>
				...
				<div class="col-sm-6 wow fadeInRight">
					...
					<div class="row">
						<div class="col-sm-12">
							<ul class="nostyle">
								<li>
									<i class="fa fa-check-square"></i> <strong>别墅户型</strong> 4层280㎡连排别墅，共6房10床
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>负一楼</strong> 睡房一（1.2米床双床房），睡房二（1.5米床单床房），麻将房
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>一楼</strong> 花园，露天温泉泡池，卡拉OK室，饭厅，厨房
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>二楼</strong> 睡房一（1.2米床双床房），睡房二（1.5米床双床房），睡房三（1.2米床双床房），共3房
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>三楼</strong> 睡房一（1.1米床单床房），共1房
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>房间配套</strong> 空调，电吹风，电视
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>厨房配套</strong> 冰箱，电磁炉，煤气炉，碗具
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>卡拉OK娱乐室配套</strong> 电视屏幕，劲爆卡拉OK音响设备，实时网络自动更新的MTV歌库，专业点歌界面，骰盅，酒杯
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>温泉池配套</strong> 一个露天温泉泡池（可容纳8人），一个私密鸳鸯温泉泡池（可容纳2个大人）
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>免费供应</strong> 1、大小共2池温泉水 2、一次性酒店住宿用品 3、全覆盖高速WiFi 4、24小时热水供应 5、全屋空调 6、厨房用具
								</li>
							</ul>
						</div>
					</div>
	...
	<section id="blog" style="padding-top: 0px; padding-bottom: 0px;">
		<div class="container" style="background: white; padding-bottom: 100px;">
			...
			<div class="row">
							...
							<article>
								<header class="entry-header">
									<div class="entry-thumbnail">
										<img class="img-responsive" src="http://static.sarah-house.cn/images/room_009_${ind }.jpg" alt=""> <span class="post-format post-format-gallery"><i class="fa fa-image"></i></span>
									</div>
								</header>
							</article>
						</div>
				...
				<!--/.col-sm-6-->
				<div class="col-sm-6">
					<c:forEach begin="22" end="34" var="ind">
						<div class="blog-post blog-large">
							<article>
								<header class="entry-header">
									<div class="entry-thumbnail">
