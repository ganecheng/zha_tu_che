	...
	<section id="services" style="padding-top: 0px; padding-bottom: 0px;">
		<div class="container" style="background: white; padding-top: 50px; padding-bottom: 0px;">
			...
			<div class="section-header">
				<h2 class="section-title text-center wow fadeInDown">云居度假别墅</h2>
				...
				<div class="col-sm-6 wow fadeInLeft">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<ul class="nostyle">
								<li>
									<i class="fa fa-check-square"></i> <strong><span id="008_level_1"></span>元</strong> 周日至周四
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong><span id="008_level_2"></span>元</strong> 周五
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong><span id="008_level_3"></span>元</strong> 周六
								</li>
								<li>
					...
					<div class="row">
						<div class="col-sm-12">
							<ul class="nostyle">
								...
								<li>
									<i class="fa fa-check-square"></i> <strong>负一楼</strong> 花园，温泉泡池，卡拉OK娱乐室，一间睡房（1.8米床单床房），饭厅，厨房
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>一楼</strong> 一间睡房（1.2米床双床房），客厅，麻将桌，茶台
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>二楼</strong> 睡房一（1.2米床双床房），睡房二（1.5米床双床房），共2房
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>三楼</strong> 睡房一（1.8米床单床房），睡房二（1.5米床双床房），共2房
								</li>
								<li>
								...
								<li>
									<i class="fa fa-check-square"></i> <strong>卡拉OK娱乐室配套</strong> 投影屏幕，劲爆卡拉OK音响设备，实时网络自动更新的MTV歌库，专业点歌界面，骰盅，酒杯
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>温泉池配套</strong> 一个楼下温泉泡池（可容纳10人），一个楼上温泉泡池（可容纳8个大人）
								</li>
								<li>
							...
							<article>
								<header class="entry-header">
									<div class="entry-thumbnail">
										<img class="img-responsive" src="http://static.sarah-house.cn/images/room_008_${ind }.jpg" alt=""> <span class="post-format post-format-gallery"><i class="fa fa-image"></i></span>
									</div>
								</header>
							</article>
						</div>
