...
<body id="home" class="homepage">
	...
	<section id="services" style="padding-top: 0px; padding-bottom: 0px;">
		<div class="container" style="background: white; padding-top: 50px; padding-bottom: 0px;">
			...
			<div class="section-header">
				<h2 class="section-title text-center wow fadeInDown">雅致度假别墅</h2>
					...
					<div class="row">
						<div class="col-sm-6">
							<ul class="nostyle">
								...
								<li>
									<i class="fa fa-check-square"></i> <strong>300m<sup>2</sup></strong> 面积
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>6</strong> 个房间
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>10</strong> 张床
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>2</strong> 张榻榻米
								</li>
								<li>
						...
						<div class="col-sm-6">
							<ul class="nostyle">
								<li>
									<i class="fa fa-check-square"></i> <strong><span id="010_level_1"></span>元</strong> 周日至周四
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong><span id="010_level_2"></span>元</strong> 周五
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong><span id="010_level_3"></span>元</strong> 周六
								</li>
								<li>
				...
				<div class="col-sm-6 wow fadeInRight">
					...
					<div class="row">
						<div class="col-sm-12">
							<ul class="nostyle">
								<li>
									<i class="fa fa-check-square"></i> <strong>别墅户型</strong> 4层300㎡连排别墅，共6房10床2张榻榻米
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>负一楼</strong> 后花园，露天温泉泡池，卡拉OK娱乐室，麻将室
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>一楼</strong> 一间睡房（1.5米床和1.2米床），饭厅，客厅，厨房，前花园
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>二楼</strong> 睡房一（1.8米床和1.2米床） 睡房二（1.5米床） 睡房三（1.8米床和1.2米床） 共3房
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>三楼</strong> 睡房一（1.5米床单床房和1张榻榻米） 睡房二（1.5米床和1.2米床及1张榻榻米） 共2房
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>房间配套</strong> 空调，有线上网端口，电吹风，电视
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>厨房配套</strong> 冰箱，电磁炉，煤气炉，碗具，消毒碗柜
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>卡拉OK娱乐室配套</strong> 投影屏幕，劲爆卡拉OK音响设备，实时网络自动更新的MTV歌库，专业点歌界面，骰盅，酒杯，镭射舞台灯光
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>温泉池配套</strong> 一个露天温泉泡池（可容纳13人）
								</li>
								<li>
	...
	<section id="blog" style="padding-top: 0px; padding-bottom: 0px;">
		<div class="container" style="background: white; padding-bottom: 100px;">
			...
			<div class="row">
				<div class="col-sm-6">
					<c:forEach begin="10" end="21" var="ind">
						<div class="blog-post blog-large">
							<article>
								<header class="entry-header">
									<div class="entry-thumbnail">
										<img class="img-responsive" src="http://static.sarah-house.cn/images/room_010_${ind }.jpg" alt=""> <span class="post-format post-format-gallery"><i class="fa fa-image"></i></span>
									</div>
								</header>
							</article>
						</div>
				...
				<!--/.col-sm-6-->
				<div class="col-sm-6">
					<c:forEach begin="22" end="32" var="ind">
						<div class="blog-post blog-large">
							<article>
								<header class="entry-header">
									<div class="entry-thumbnail">
