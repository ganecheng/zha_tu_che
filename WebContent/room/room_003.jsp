...
<title>春巴泰阁精品系列民宿-美雅2号度假别墅</title>
<!-- core CSS -->
...
<body id="home" class="homepage">
	...
	<section id="services" style="padding-top: 0px; padding-bottom: 0px;">
		<div class="container" style="background: white; padding-top: 50px; padding-bottom: 0px;">
			...
			<div class="section-header">
				<h2 class="section-title text-center wow fadeInDown">美雅2号度假别墅</h2>
					...
					<div class="row">
						<div class="col-sm-6">
							<ul class="nostyle">
								...
								<li>
									<i class="fa fa-check-square"></i> <strong>250m<sup>2</sup></strong> 面积
								</li>
								<li>
								...
								<li>
									<i class="fa fa-check-square"></i> <strong>1</strong> 个烧烤炉
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>1</strong> 桌球
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>1</strong> 乒乓球桌
								</li>
							</ul>
						</div>
						...
						<div class="col-sm-6">
							<ul class="nostyle">
								<li>
									<i class="fa fa-check-square"></i> <strong><span id="003_level_1"></span>元</strong> 周日至周四
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong><span id="003_level_2"></span>元</strong> 周五
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong><span id="003_level_3"></span>元</strong> 周六
								</li>
								<li>
				...
				<div class="col-sm-6 wow fadeInRight">
					...
					<div class="row">
						<div class="col-sm-12">
							<ul class="nostyle">
								<li>
									<i class="fa fa-check-square"></i> <strong>别墅户型</strong> 4层250㎡独栋别墅，共5房9床
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>负一楼</strong> 卡拉OK娱乐室，桌球室，乒乓球室
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>一楼</strong>一间睡房（1.2米床单床房），饭桌，大厅，厨房，自动麻将台
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>二楼</strong> 睡房一（1.2米床双床房） 睡房二（1.2米床双床房） 睡房三（1.8米床单床房） 共3房
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>三楼</strong> 睡房一（1.5米床双床，1.2米床单床） 共1房
								</li>
								<li>
								...
								<li>
									<i class="fa fa-check-square"></i> <strong>温泉池配套</strong> 一个独立温泉泡池（可容纳10人）
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>免费供应</strong> 1、1池温泉水 2、一次性酒店住宿用品 3、全覆盖高速WiFi 4、24小时热水供应 5、全屋空调 6、厨房用具 7、乒乓球桌、桌球
								</li>
							</ul>
						</div>
					</div>
	...
	<section id="blog" style="padding-top: 0px; padding-bottom: 0px;">
		<div class="container" style="background: white; padding-bottom: 100px;">
			...
			<div class="row">
				<div class="col-sm-6">
					<c:forEach begin="10" end="18" var="ind">
						<div class="blog-post blog-large">
							<article>
								<header class="entry-header">
									<div class="entry-thumbnail">
										<img class="img-responsive" src="http://static.sarah-house.cn/images/room_003_${ind }.jpg" alt=""> <span class="post-format post-format-gallery"><i class="fa fa-image"></i></span>
									</div>
								</header>
							</article>
						</div>
				...
				<!--/.col-sm-6-->
				<div class="col-sm-6">
					<c:forEach begin="19" end="27" var="ind">
						<div class="blog-post blog-large">
							<article>
								<header class="entry-header">
									<div class="entry-thumbnail">
