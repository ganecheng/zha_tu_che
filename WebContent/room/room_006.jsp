...
<body id="home" class="homepage">
	...
	<section id="services" style="padding-top: 0px; padding-bottom: 0px;">
		<div class="container" style="background: white; padding-top: 50px; padding-bottom: 0px;">
			...
			<div class="section-header">
				<h2 class="section-title text-center wow fadeInDown">公寓</h2>
				...
				<div class="col-sm-6 wow fadeInLeft">
					...
					<div class="row">
						<div class="col-sm-6">
							<ul class="nostyle">
								<li>
									<i class="fa fa-check-square"></i> <strong>15</strong> 楼洋房
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>86m<sup>2</sup></strong> 面积
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>2</strong> 个房间
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>3</strong> 张床
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>1</strong> 个厨房
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>0</strong> 个麻将台
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>0</strong> KTV
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>0</strong> 个温泉泡池
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>0</strong> 烧烤炉
								</li>
								<li>
						...
						<div class="col-sm-6">
							<ul class="nostyle">
								<li>
									<i class="fa fa-check-square"></i> <strong><span id="006_level_1"></span>元</strong> 周日至周四
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong><span id="006_level_2"></span>元</strong> 周五
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong><span id="006_level_3"></span>元</strong> 周六
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>不提供</strong> 早餐预订
								</li>
								<li>
				...
				<div class="col-sm-6 wow fadeInRight">
					...
					<div class="row">
						<div class="col-sm-12">
							<ul class="nostyle">
								<li>
									<i class="fa fa-check-square"></i> <strong>别墅户型</strong> 83㎡2房2厅公寓洋房，共3床
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>房间</strong> 睡房一（1.2米床双床房）、睡房二（1.5米床单床房）
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>房间配套</strong> 空调
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>厨房配套</strong> 煤气炉，消毒碗柜，餐具
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>免费供应</strong> 1、一次性酒店住宿用品 2、全覆盖高速WiFi 3、24小时热水供应 4、免费停车位 5、全屋空调 6、厨房用具
								</li>
							</ul>
						</div>
					</div>
	...
	<section id="blog" style="padding-top: 0px; padding-bottom: 0px;">
		<div class="container" style="background: white; padding-bottom: 100px;">
			...
			<div class="row">
				<div class="col-sm-6">
					<c:forEach begin="10" end="14" var="ind">
						<div class="blog-post blog-large">
							<article>
								<header class="entry-header">
									<div class="entry-thumbnail">
										<img class="img-responsive" src="http://static.sarah-house.cn/images/room_006_${ind }.jpg" alt=""> <span class="post-format post-format-gallery"><i class="fa fa-image"></i></span>
									</div>
								</header>
							</article>
						</div>
				...
				<!--/.col-sm-6-->
				<div class="col-sm-6">
					<c:forEach begin="15" end="18" var="ind">
						<div class="blog-post blog-large">
							<article>
								<header class="entry-header">
									<div class="entry-thumbnail">
