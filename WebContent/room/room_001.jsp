...
<body id="home" class="homepage">
	...
	<section id="services" style="padding-top: 0px; padding-bottom: 0px;">
		<div class="container" style="background: white; padding-top: 50px; padding-bottom: 0px;">
			...
			<div class="section-header">
				<h2 class="section-title text-center wow fadeInDown">春笆阁度假别墅</h2>
				...
				<div class="col-sm-6 wow fadeInLeft">
					...
					<div class="row">
						<div class="col-sm-6">
							<ul class="nostyle">
								<li>
									<i class="fa fa-check-square"></i> <strong>4</strong> 层别墅
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>330m<sup>2</sup></strong> 面积
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>6</strong> 个房间
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>11</strong> 张床
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>1</strong> 个厨房
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>1</strong> 间麻将室
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>1</strong> KTV
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>2</strong> 个温泉泡池
								</li>
								<li>
						...
						<div class="col-sm-6">
							<ul class="nostyle">
								<li>
									<i class="fa fa-check-square"></i> <strong><span id="001_level_1"></span>元</strong> 周日至周四
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong><span id="001_level_2"></span>元</strong> 周五
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong><span id="001_level_3"></span>元</strong> 周六
								</li>
								<li>
				...
				<div class="col-sm-6 wow fadeInRight">
					...
					<div class="row">
						<div class="col-sm-12">
							<ul class="nostyle">
								<li>
									<i class="fa fa-check-square"></i> <strong>别墅户型</strong> 4层330㎡连排别墅，共6房11床
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>负一楼</strong> 后花园，露天温泉泡池，卡拉OK娱乐室，麻将室
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>一楼</strong> 一间睡房（1.8米床和1.2米床），饭厅，客厅，厨房，前花园
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>二楼</strong> 东睡房（1.8米床和1.2米床） 观星房（1.5米床） 西睡房（1.8米床和1.2米床） 共3房
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>三楼</strong> 东睡房（1.8米床和1.2米床） 西睡房（1.8米床和1.2米床） 共2房
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>房间配套</strong> 空调，有线上网端口，热水壶，电吹风，电视
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>厨房配套</strong> 西门子双门冰箱，电磁炉，煤气炉，碗具，消毒碗柜，微波炉，烤箱，岛台，胶囊咖啡机
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>卡拉OK娱乐室配套</strong> 100寸全投影屏幕，劲爆卡拉OK音响设备，实时网络自动更新的MTV歌库，专业点歌界面，骰盅，酒杯，镭射舞台灯光
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>温泉池配套</strong> 一个露天温泉泡池（可容纳12人） 一个私密鸳鸯泡池（可容纳2个大人+1小朋友）
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>免费供应</strong> 1、大小共2池温泉水 2、一次性酒店住宿用品 3、全覆盖高速WiFi 4、24小时热水供应 5、全屋空调 6、5杯胶囊咖啡 7、厨房用具
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>有偿服务</strong> 1、私房菜预定服务 2、除免费提供外的咖啡胶囊 3、洗衣服务 4、绿色食品材料预定采购服务 5、早餐预定服务
								</li>
							</ul>
						</div>
					</div>
	...
	<section id="blog" style="padding-top: 0px; padding-bottom: 0px;">
		<div class="container" style="background: white; padding-bottom: 100px;">
			...
			<div class="row">
				<div class="col-sm-6">
					<c:forEach begin="10" end="26" var="ind">
						<div class="blog-post blog-large">
							<article>
								<header class="entry-header">
									<div class="entry-thumbnail">
										<img class="img-responsive" src="http://static.sarah-house.cn/images/room_001_${ind }.jpg" alt=""> <span class="post-format post-format-gallery"><i class="fa fa-image"></i></span>
									</div>
								</header>
							</article>
						</div>
				...
				<!--/.col-sm-6-->
				<div class="col-sm-6">
					<c:forEach begin="27" end="45" var="ind">
						<div class="blog-post blog-large">
							<article>
								<header class="entry-header">
									<div class="entry-thumbnail">
