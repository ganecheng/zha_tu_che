...
<body id="home" class="homepage">
	...
	<section id="services" style="padding-top: 0px; padding-bottom: 0px;">
		<div class="container" style="background: white; padding-top: 50px; padding-bottom: 0px;">
			...
			<div class="section-header">
				<h2 class="section-title text-center wow fadeInDown">静庐度假别墅</h2>
					...
					<div class="row">
						<div class="col-sm-6">
							<ul class="nostyle">
								...
								<li>
									<i class="fa fa-check-square"></i> <strong>7</strong> 个房间
								</li>
								<li>
						...
						<div class="col-sm-6">
							<ul class="nostyle">
								<li>
									<i class="fa fa-check-square"></i> <strong><span id="004_level_1"></span>元</strong> 周日至周四
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong><span id="004_level_2"></span>元</strong> 周五
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong><span id="004_level_3"></span>元</strong> 周六
								</li>
								<li>
				...
				<div class="col-sm-6 wow fadeInRight">
					...
					<div class="row">
						<div class="col-sm-12">
							<ul class="nostyle">
								<li>
									<i class="fa fa-check-square"></i> <strong>别墅户型</strong> 4层300㎡连排别墅，共7房10床
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>负一楼</strong> 后花园，露天温泉泡池，卡拉OK娱乐室，一间睡房（1.2米床单床房）
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>一楼</strong> 一间睡房（1.5米床和1.2米床），饭厅，客厅，麻将桌，厨房，前花园
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>二楼</strong> 睡房一（2.2米圆床单床房）睡房二（1.5米床双床房）睡房三（1.5米床单床房）共3房
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>三楼</strong> 睡房一（1.5米床单床房）睡房二（1.5米床双床房）共2房
								</li>
								<li>
								...
								<li>
									<i class="fa fa-check-square"></i> <strong>卡拉OK娱乐室配套</strong> 电视屏幕，劲爆卡拉OK音响设备，实时网络自动更新的MTV歌库，专业点歌界面，骰盅，酒杯，镭射舞台灯光
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>温泉池配套</strong> 一个露天温泉泡池（可容纳12人）
								</li>
								<li>
	...
	<section id="blog" style="padding-top: 0px; padding-bottom: 0px;">
		<div class="container" style="background: white; padding-bottom: 100px;">
			...
			<div class="row">
				<div class="col-sm-6">
					<c:forEach begin="10" end="23" var="ind">
						<div class="blog-post blog-large">
							<article>
								<header class="entry-header">
									<div class="entry-thumbnail">
										<img class="img-responsive" src="http://static.sarah-house.cn/images/room_004_${ind }.jpg" alt=""> <span class="post-format post-format-gallery"><i class="fa fa-image"></i></span>
									</div>
								</header>
							</article>
						</div>
				...
				<!--/.col-sm-6-->
				<div class="col-sm-6">
					<c:forEach begin="24" end="40" var="ind">
						<div class="blog-post blog-large">
							<article>
								<header class="entry-header">
									<div class="entry-thumbnail">
