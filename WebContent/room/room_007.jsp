...
<title>春巴泰阁精品系列民宿-花藤小院度假别墅</title>
<!-- core CSS -->
...
<body id="home" class="homepage">
	...
	<section id="services" style="padding-top: 0px; padding-bottom: 0px;">
		<div class="container" style="background: white; padding-top: 50px; padding-bottom: 0px;">
			...
			<div class="section-header">
				<h2 class="section-title text-center wow fadeInDown">花藤小院度假别墅</h2>
				...
				<div class="col-sm-6 wow fadeInLeft">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<ul class="nostyle">
								<li>
									<i class="fa fa-check-square"></i> <strong><span id="007_level_1"></span>元</strong> 周日至周四
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong><span id="007_level_2"></span>元</strong> 周五
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong><span id="007_level_3"></span>元</strong> 周六
								</li>
								<li>
					...
					<div class="row">
						<div class="col-sm-12">
							<ul class="nostyle">
								...
								<li>
									<i class="fa fa-check-square"></i> <strong>负一楼</strong> 车库，温泉泡池，卡拉OK娱乐室，一间睡房，（1.2米床双床房）
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>一楼</strong> 一间睡房，（1.8米床单床房），饭厅，客厅，麻将桌，厨房，花园
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>二楼</strong> 睡房一（1.2米床双床房），睡房二（1.5米床双床房），共2房
								</li>
								<li>
									<i class="fa fa-check-square"></i> <strong>三楼</strong> 睡房一（1.8米床单床房），睡房二（1.5米床双床房），露台+温泉泡池，共2房
								</li>
								<li>
								...
								<li>
									<i class="fa fa-check-square"></i> <strong>温泉池配套</strong> 一个露天温泉泡池（可容纳8人） 一个私密鸳鸯泡池（可容纳2个大人+1小朋友）
								</li>
								<li>
	...
	<section id="blog" style="padding-top: 0px; padding-bottom: 0px;">
		<div class="container" style="background: white; padding-bottom: 100px;">
			...
			<div class="row">
				<div class="col-sm-6">
					<c:forEach begin="10" end="24" var="ind">
						<div class="blog-post blog-large">
							<article>
								<header class="entry-header">
									<div class="entry-thumbnail">
										<img class="img-responsive" src="http://static.sarah-house.cn/images/room_007_${ind }.jpg" alt=""> <span class="post-format post-format-gallery"><i class="fa fa-image"></i></span>
									</div>
								</header>
							</article>
						</div>
				...
				<!--/.col-sm-6-->
				<div class="col-sm-6">
					<c:forEach begin="25" end="38" var="ind">
						<div class="blog-post blog-large">
							<article>
								<header class="entry-header">
									<div class="entry-thumbnail">
