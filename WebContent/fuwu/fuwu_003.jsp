...
<body id="home" class="homepage">
	...
	<section id="story_div" style="margin-top: 150px;">
		<div class="container" style="background-color: #007dcf; padding-top: 20px;">
			<ol class="breadcrumb">
				<li>
					<a href="item/index.jsp">首页</a>
				</li>
				...
				<li class="active">管家服务</li>
			</ol>
		</div>
	</section>
	<section id="meet-team" style="padding-top: 0px; padding-bottom: 0px; margin-bottom: 56px;">
		<div class="container" style="background-color: #007dcf; padding-top: 10px; padding-bottom: 100px;">
			<div class="row">
				<div class="col-sm-6 col-md-8">
					<div class="team-member wow bounceInLeft animated" data-wow-duration="400ms" data-wow-delay="0ms">
						<div class="team-img" style="margin: -15px -15px -15px -15px;">
							<img class="img-responsive" src="images/fuwu_03_detail_01.jpg" alt="">
						</div>
					</div>
				</div>
				<div class="col-sm-6 col-md-4">
					<div class="team-member wow bounceInRight animated" data-wow-duration="400ms" data-wow-delay="0ms">
						<div class="team-img" style="margin: -15px -15px -15px -15px;">
							<img class="img-responsive" src="images/fuwu_right_pic_03.jpg" alt="">
						</div>
					</div>
				</div>
			</div>
